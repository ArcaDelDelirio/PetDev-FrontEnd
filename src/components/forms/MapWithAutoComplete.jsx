...
class MapWithAutoComplete extends React.Component{constructor( props ){
  super( props );
  this.state = {
   address: '',
   city: '',
 ...
 onMarkerDragEnd = ( event ) => {
  ...
  if( this.props.center.lat !== undefined ) {
   map = <div>
     ...
     <AsyncMap
      googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyBzGVNtpx96mevl5hXFpx7n-ZeAeM3u1k8&libraries=places"
      loadingElement={
